    ...
    <div class="v52fmbx">
		...
		<dl>
			...
			<dd class="ftype_input">
				...
				<div class="fbox">
					<input type="text" name="exhibitionnum" value="" class="">
				</div>
...
<!--
EOT;
echo '--><dl><dt>行业</dt><dd class="ftype_checkbox ftype_transverse"><div class="form-inline" style="margin-bottom:10px;"><div class="radio">';
